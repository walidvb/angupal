...
<!-- Built by the great vbbros! More info on vbbros.net or info@vbbros.net  -->
  ...
  <body ng-app="myApp" class="initial-state">
    <?php print  $classes . $app_path . 'hello world!' ?>
    <!--[if lt IE 7]>
    ...
    <div class="">
      <ng-include src="sites/all/themes/angupal/angular/app/views/main.html'"></ng-include>
      </div>
    ...
    <!-- endbuild -->
        ...
        <script>
          ...
          base_path += "/sites/all/themes/angupal/angular/app";
